...
class DictionaryTests: XCTestCase {
    ...
    func testJson_ShouldGoBothWays(){
        ...
        let sut = UserDictionary(dictionaryId: "00-00-000", userRef: "00-10-1111", enfocaId: NSNumber(integerLiteral: 8), termTitle: "Jokes", definitionTitle: "Punchlines", subject: "LOLz", language: "en")
        ...
        XCTAssertEqual(sut.enfocaId, copy.enfocaId)
    ...
    func testJson_ShouldGoBothWaysWithOptionals(){
        ...
        let sut = UserDictionary(dictionaryId: "00-00-000", userRef: "00-10-1111", enfocaId: NSNumber(integerLiteral: 8), termTitle: "Jokes", definitionTitle: "Punchlines", subject: "LOLz")
